...
\title{Towards a Peer-to-Peer Instant Messaging System using MaidSafe Libraries}%\subtitle{COMP-512 Report 1}
\author{\copyright~Erick Lavoie}
%\institution{McGill University}
\date{November 25th, 2013}			% Activate to display a given date or no date
